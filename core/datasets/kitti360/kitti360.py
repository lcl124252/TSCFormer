...
class KITTI360Dataset(Dataset):
    ...
    def parse_poses(filename, calibration):
        ...
        poses = dict()
        cam2pose = np.array([
            0.0371783278, -0.0986182135, 0.9944306009, 1.5752681039, 0.9992675562, -0.0053553387, -0.0378902567,
            0.0043914093, 0.0090621821, 0.9951109327, 0.0983468786, -0.6500000000
        ]).reshape(3, 4)
