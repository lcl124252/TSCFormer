...
class temporalDepthAggregation(nn.Module):
    def __init__(self, 
        embed_dims=32,
        out_channels=1):
        super(temporalDepthAggregation, self).__init__()
    ...
    def forward(self, depth_stereo, depth_mono):
        ...
        refine_stereo = self.stereo_mono_attention(depth_stereo, depth_mono)
        
        depth_feat = torch.cat([refine_stereo.unsqueeze(1), stereo_mono.unsqueeze(1)], dim=1)
